...
urlpatterns = [
    ...
    path('api/v1/movie/', views.movie_list_create_api_view),
    path('api/v1/review/', views.review_list_create_api_view),
    ...
    path('api/v1/movies/reviews/', views.movie_with_reviews_api_view)
]
